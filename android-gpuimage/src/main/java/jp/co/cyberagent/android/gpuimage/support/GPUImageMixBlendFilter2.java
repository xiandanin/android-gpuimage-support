...
public class GPUImageMixBlendFilter2 extends GPUImageTwoInputFilter2 {

    private int mMixLocation;
    private float mMix;

    public GPUImageMixBlendFilter2(String fragmentShader) {
        this(fragmentShader, 0.5f);
    }

    public GPUImageMixBlendFilter2(String fragmentShader, float mix) {
